...
const excelCourses: Course[] = [
  ...
  },
  {
    ...
    instructor: 'Dr. Priya Sharma',
    description: 'Learn to transform, clean and analyze large datasets with Excel Power Query, create data models with Power Pivot, and write DAX formulas for advanced business intelligence and reporting.',
    price: 89.99,
    inrPrice: 7499,
    image: 'https://images.unsplash.com/photo-1543286386-713bdd548da4?q=80&w=2070&auto=format&fit=crop',
    category: 'Excel',
    ...
    rating: 4.8,
    students: 12450,
    tags: ['Power Query', 'Power Pivot', 'DAX', 'Business Intelligence', 'Data Modeling']
  },
  {
    id: 'excel-4',
    title: 'Financial Modeling in Excel',
    instructor: 'Raj Patel',
    description: 'Build professional financial models in Excel including DCF valuation, LBO modeling, M&A analysis, and sensitivity studies. Learn to create dynamic financial projections for business planning and investment analysis.',
    price: 94.99,
    inrPrice: 7899,
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop',
    category: 'Excel',
    ...
    rating: 4.7,
    students: 9820,
    tags: ['Financial Modeling', 'DCF Analysis', 'Valuation', 'Finance', 'Forecasting']
  },
  {
    id: 'excel-5',
    title: 'Excel Dashboard & Data Visualization',
    instructor: 'Ananya Desai',
    description: 'Create impressive interactive dashboards and data visualizations in Excel. Learn to design professional reports using charts, slicers, conditional formatting, and other Excel tools to transform data into actionable insights.',
    price: 79.99,
    inrPrice: 6599,
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop',
    category: 'Excel',
    ...
    rating: 4.8,
    students: 15340,
    tags: ['Dashboards', 'Data Visualization', 'Charts', 'Reporting', 'Business Intelligence']
  },
  {
    id: 'excel-6',
    title: 'Excel VBA Programming for Automation',
    instructor: 'Michael Rodriguez',
    description: 'Master Excel VBA to automate repetitive tasks, create custom functions, build user forms, and develop sophisticated applications. Learn to write efficient VBA code to enhance Excel functionality and save hours of manual work.',
    price: 84.99,
    inrPrice: 6999,
    ...
    rating: 4.6,
    students: 11280,
    tags: ['VBA', 'Macros', 'Automation', 'Programming', 'User Forms']
  },
  {
    id: 'excel-7',
    title: 'Excel for Data Analysis',
    instructor: 'Dr. Sarah Chen',
    description: 'Learn to use Excel as a powerful data analysis tool. Master data import, cleaning, transformation, statistical analysis, and creating meaningful visualizations to derive insights and make data-driven decisions.',
    price: 69.99,
    inrPrice: 5799,
    image: 'https://images.unsplash.com/photo-1633613286848-e6f43bbafb8d?q=80&w=2070&auto=format&fit=crop',
    category: 'Excel',
    level: 'Intermediate',
    duration: '6 weeks',
    lessons: 30,
    rating: 4.8,
    students: 18650,
    tags: ['Data Analysis', 'Statistics', 'Data Cleaning', 'Visualization', 'Decision Making']
  },
  {
    id: 'excel-8',
    title: 'Excel for HR Analytics',
    instructor: 'Ananya Desai',
    description: 'Apply Excel techniques to HR data for workforce analytics and talent management. Learn to create HR dashboards, analyze employee data, forecast workforce needs, and measure HR KPIs to optimize HR operations and strategy.',
    price: 74.99,
    inrPrice: 6249,
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop',
    category: 'Excel',
    ...
    rating: 4.5,
    students: 6840,
    tags: ['HR Analytics', 'Workforce Planning', 'KPIs', 'Dashboard', 'Talent Management']
  },
  {
    id: 'excel-9',
    title: 'Excel for Project Management',
    instructor: 'Alex Thompson',
    description: 'Use Excel to plan, track, and manage projects effectively. Create Gantt charts, project schedules, resource allocation tools, budget trackers, and status reports to keep your projects on track and within budget.',
    price: 79.99,
    inrPrice: 6599,
    image: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop',
    category: 'Excel',
    ...
    rating: 4.7,
    students: 8920,
    tags: ['Project Management', 'Gantt Charts', 'Resource Planning', 'Budgeting', 'Tracking']
  },
  {
    id: 'excel-10',
    title: 'Excel Pivot Tables & Power BI Integration',
    instructor: 'Raj Patel',
    description: 'Master Excel Pivot Tables and learn to integrate Excel with Power BI for advanced business intelligence. Create dynamic reports, interactive dashboards, and powerful data models that connect multiple data sources.',
    price: 89.99,
    inrPrice: 7499,
    ...
    rating: 4.9,
    students: 10520,
    tags: ['Pivot Tables', 'Power BI', 'Data Analysis', 'Business Intelligence', 'Reporting']
  }
];

export const allCourses = [...sampleCourses, ...programmingCourses, ...cryptoCourses, ...businessCourses, ...excelCourses];
